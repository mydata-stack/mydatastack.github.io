...
import hdstack from "../assets/images/icon.png";
...
const navbarLinks = [
  ...
  { label: "Getting started", href: "/getting-started", ariaLabel: "Getting Started" },
];
          ...
          <a className="navbar-link" href="/" aria-label="Home">
            <div className="flex justify-start items-center grow basis-0">
              <div className="text-white mr-2 text-6xl">
                <img src={hdstack} style={{'max-height': '60px;'}}/>
              </div>
        ...
        >
          <div className="grow basis-0 justify-end hidden lg:flex">
           ...
           bg-customDarkBg2 hover:bg-customDarkBg3  border-gray-700 pl-6 pr-8 pt-2 pb-2 text-sm flex"
              href="https://github.com/mydata-stack/mydata-stack"
              target="_blank"
